    ...
    <main className="pmain">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "200px 1fr", gap: 32 }}>
        ...
        <article className="doc">
          ...
          <p>
            Head to <Link href="/keys" style={{ color: "var(--accent)" }}>API keys</Link> and
          ...
          <p>
            ...
            Pick any model from the <Link href="/models" style={{ color: "var(--accent)" }}>catalog</Link>.
          </p>
          <div className="tabs-pills">
...
# Response header x-cache: HIT | MISS | BYPASS`)}>
          ...
          <ul>
            <li><code>401</code> — missing or invalid API key. Check <Link href="/keys" style={{ color: "var(--accent)" }}>your keys</Link>.</li>
            ...
            <li><code>403</code> — model not in your team&apos;s allow-list. Check the <Link href="/models" style={{ color: "var(--accent)" }}>catalog</Link>.</li>
          ...
          <div className="callout" style={{ marginTop: 16 }}>
            ...
            The playground at <Link href="/playground" style={{ color: "var(--accent)" }}>Playground</Link> is
            the fastest way to verify your key works.
          </div>

          <h2 id="next">Next steps</h2>
          <ul>
            <li><Link href="/playground" style={{ color: "var(--accent)" }}>Open the Playground</Link> — iterate on prompts in the browser before writing code.</li>
            <li><Link href="/agents" style={{ color: "var(--accent)" }}>Build an agent</Link> — compose tool-using agents with MCP servers.</li>
            <li><Link href="/usage" style={{ color: "var(--accent)" }}>View your usage</Link> — cost breakdown by model, session, and day.</li>
            <li><Link href="/models" style={{ color: "var(--accent)" }}>Browse the model catalog</Link> — see available models and their capabilities.</li>
          </ul>
        </article>
      </div>
    </main>
