    ...
    <div className="page">
      ...
      <div className="lg-hero">
        ...
        <div className="lg-hero__actions">
          <Link href="/league/leaderboard" className="btn">🏆 Leaderboard</Link>
          <Link href="/league/results" className="btn">📊 My results</Link>
          <Link href="/league/store" className="btn">🛒 Reward shop</Link>
    ...
    <div className={`lg-quest ${mod}`}>
      ...
      <div className="lg-quest__meta">
        ...
        {challenge.status === "active" ? (
          <Link href={`/playground?challenge=${challenge.id}`} className="lg-btn-gold">
            ▶ Start quest
          </Link>
        ) : (
          <Link href={`/league/results?challenge=${challenge.id}`} className="btn btn--sm">
            View results
          </Link>
        )}
      </div>
